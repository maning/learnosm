...
-   To load the paper into JOSM, we need to copy the ID of the Field
    ...
    [http://fieldpapers.org/snapshot.php?id=llk796ms#16/14.6542/121.1104](http://fieldpapers.org/snapshot.php?id=llk796ms#16/14.6542/121.1104)
...
[paper exmaple 2]: {{site.baseurl}}/images/fieldp.png
