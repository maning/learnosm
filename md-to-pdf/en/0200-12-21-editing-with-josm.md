...
In [Chapter 3](#start-josm) you installed JOSM and began drawing your first points,
...
**Download** the current map data from OSM
  ...
  - [Tour of JOSM](#a-tour-of-josm)
  - [Download OSM Data](#download-osm-data)
  - [JOSM Layers](#josm-layers)
...
**Save** changes to OpenStreetMap
  ...
  - [See Your Changes on the Map](#see-your-changes-on-the-map)
  - [Saving OSM files](#saving-osm-files)
