...
-   The website should look something like this: (Figure 91)

    ![Field paper 1][]

-   Click **Make yourself an Atlas** to select the area you want to print out. (Figure 92)

	![Make atlas][]

    It will direct to the page: (Figure 93)
...
-   The map that you see shows the area that you would like to print on
    ...
    also zoom in and out. (Figure 94)
...
- After that, you will name your map and add optional text to each page. (Figure 99)

	![Name][]
	
- The next option lets you select a layout. It comes with three options.
	You may add a UTM grid overlay to each map if you want to. (Figure 100)
...
-   You will see a new page which says that your print is being
    ...
    minutes for a print to be completed. (Figure 101)

    ![Paper prepare print][]

-   When your print is ready, click "Download map PDF for print". The
    Field Paper should begin downloading. (Figure 102)
...
[Paper on id]: /home/dianne/Development/git/learnosm/images/id.png
...
[Field paper 1]: /home/dianne/Development/git/learnosm/images/Homepage.png
...
[Edit iD or Potlatch]: /home/dianne/Development/git/learnosm/images/editinidorpot.png
[Make atlas]: /home/dianne/Development/git/learnosm/images/makeatlas.png
[Choose tile]: /home/dianne/Development/git/learnosm/images/choosetile.png
[Black and white]: /home/dianne/Development/git/learnosm/images/blackandwhite.png
[Label next]: /home/dianne/Development/git/learnosm/images/labelnext.png
[Scanned map]: /home/dianne/Development/git/learnosm/images/scannedmap.png
[Fieldpaper snap shot]: /home/dianne/Development/git/learnosm/images/fsnapshot.png
[Field paper id]: /home/dianne/Development/git/learnosm/images/fieldpaperid.png
[Fieldpaper in JOSM]: /home/dianne/Development/git/learnosm/images/fieldpaperjosm.png
[Zoom in/out]: /home/dianne/Development/git/learnosm/images/zoominout.png
[Download Pdf]: /home/dianne/Development/git/learnosm/images/downloadpdf.png
