...
without a GPS. We will use a tool called Field Papers, which allow you
...
4. In ID or in PotLatch, load the Field Paper. Use the objects you draw as
...
-   Field Papers are very useful for mapping with nothing more than
    ...
    on OpenStreetMap.
-   The first step is to scan your Field Paper into your computer. You
...
-   Click "Save." Your Field Paper will begin to process. This may
...
-   To load the paper into JOSM, we need to copy the ID of the Field
    ...
    [http://fieldpapers.org/snapshot.php?id=x4chhv94#18/7.72925/81.69137](http://fieldpapers.org/snapshot.php?id=x4chhv94#18/7.72925/81.69137)
-   Now open JOSM. In Chapter 3 we installed the Field Papers plugin,
...
-   After you add your changes to OSM, they will finally be saved on the
    ...
    out a new Field Paper which will include the changes that you
...
[paper exmaple 2]: {{site.baseurl}}/images/fieldpaperprtsc.png
