...
- [PicLayer]({{site.baseurl}}/en/lgu1/josm-plugins/#piclayer) (allows you to display any picture as a background in the editor)
...
![]({{site.baseurl}}/images/PicLayer plugin.png)
...
PicsLayer in the layers list and activate it.
   ...
   ![]({{site.baseurl}}/images/Layers list.png)
